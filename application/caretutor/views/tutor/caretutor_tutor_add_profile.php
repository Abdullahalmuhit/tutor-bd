					                            		...
					                            		<div class="uk-margin-top">
				                                            ...
				                                            <div class="uk-grid" data-uk-grid-margin>
				                                                <div class="uk-width-medium-1-2">
				                                                    <label class="uk-text-hilight" for="user_edit_uname_control">City</label>
				                                                    <select id="tutor_profile_city" name="tutor_profile_city" data-md-selectize>
				                                                ...
				                                                <div class="uk-width-medium-1-2 locatin_hide" id="your_location_show" <?php echo (!empty($tution_info))?($tution_info[0]['city_id'] == '3')?'style="display: none;"':'':''; ?>>
				                                                    <label class="uk-text-hilight" for="user_edit_position_control">Your location</label>
				                                                    <select id="tutor_profile_your_location" name="tutor_profile_your_location" data-md-selectize>
