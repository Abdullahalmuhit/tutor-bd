...
<div id="page_content">
    <div id="page_content_inner">
        ...
        <div class="md-card">
            <div class="md-card-content tutor_dashboard">
                <div class="uk-grid" data-uk-grid-margin="">
                    <div class="uk-width-medium-2-10">
                        <div class="uk-margin-small-top">
                            <select id="filter_city" name="filter_city" data-md-selectize>
                    ...
                    <div class="uk-width-medium-2-10" id="location_show">
                        <div class="uk-margin-small-top">
                            <select id="filter_location" name="filter_location" data-md-selectize multiple data-md-selectize-bottom>
                    ...
                    <div class="uk-width-medium-2-10">
                        <div class="uk-margin-small-top">
                            <select id="filter_category" name="filter_category" data-md-selectize multiple data-md-selectize-bottom>
                    ...
                    <div class="uk-width-medium-2-10" id="class_show">
                        <div class="uk-margin-small-top">
                            <select id="filter_class" name="filter_class" data-md-selectize multiple data-md-selectize-bottom>
                    ...
                    <div class="uk-width-medium-2-10">
                        <div class="uk-margin-small-top">
                            <select id="filter_gender" name="filter_gender" data-md-selectize multiple data-md-selectize-bottom>
