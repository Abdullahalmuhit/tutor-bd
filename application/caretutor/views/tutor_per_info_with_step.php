<form id="frmperinfo" data-link="tutor/update_personal_info_step" class="form-horizontal margin_top" role="form">
		...
		<div class="panel panel-default">
				...
				<div class="panel-body" style="text-align: center;">
					...
					<div class="input-group"> 
						...
						<input id="fathers_name" name="fathers_name" required type="text" class="form-control" placeholder="Father's Name" value="" />
					</div>
			<!-- 		<div class="input-group">  -->
			...
			<!-- 		</div> -->
					<div class="input-group"> 
						...
						<input id="additional_numbers" name="additional_numbers" required type="text" class="form-control" placeholder="Additional Contact Number" value="" />
					</div>
					<div class="input-group"> 
					...
					<div class="input-group"> 
						...
						<input id="fb_link" name="fb_link" type="url" pattern="http://www\.facebook\.com\/(.+)|https://www\.facebook\.com\/(.+)" required class="form-control" placeholder="facebook profile link" />
					</div>
					...
					<div class="input-group"> 
						...
						<textarea name="pre_address" rows="4" class="form-control" placeholder="Please Provide Your Detail Address"></textarea>
					</div>
					...
					<div class="input-group"> 
						...
						<input id="national_id" name="national_id" type="text" class="form-control" placeholder="National ID" value="" />
					</div>
					<div class="input-group"> 
						<h5 class="input-group-addon"><span><i class="fa fa-user"></i> </span><b>Passport Number</b></h5>
						<input id="passport_number" name="passport_number" type="text" class="form-control" placeholder="Passport Number" value="" />
					</div>
					...
					<fieldset>
						...
						<div class="input-group"> 
							...
							<input id="emmergency_contact_name" name="emmergency_contact_name" type="text" class="form-control" placeholder= "Name" value="" />
						</div>
						<div class="input-group"> 
							<h5 class="input-group-addon"><span><i class="fa fa-mobile"></i> </span><b>Contact Number  </b></h5>
							<input id="emmergency_contact_number" name="emmergency_contact_number" type="text" class="form-control" placeholder="Number" value="" />
						</div>
						<div class="input-group"> 
							<h5 class="input-group-addon"><span><i class="fa fa-user"></i> </span><b>Relation  </b></h5>
							<input id="emmergency_contact_rel" name="emmergency_contact_rel" type="text" class="form-control" placeholder="Relation" value="" />
						</div>
					</fieldset>
