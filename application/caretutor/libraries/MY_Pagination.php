<?php  if ( ! defined('BASEPATH')) exit('No direct script access allowed');
	...
	*/
	class MY_Pagination extends CI_Pagination {
		...
		var $last_link			= '&raquo;';
		var $uri_segment		= 3;
		var $full_tag_open		= '<ul class="pagination" style="margin-top:0;">';
		var $html               = '';
		var $full_tag_close		= "</ul>";
		var $first_tag_open		= '<li class="">';
		var $first_tag_close	= '</li>';
		var $last_tag_open		= '<li class="">';
		var $last_tag_close		= '</li>';
		var $first_url			= ''; // Alternative URL for the First Page.
		var $cur_tag_open		= '<li class="active"><a href="javascript:void(0)">';
		var $cur_tag_close		= '</a></li>';
		var $next_tag_open		= '<li class="">';
		var $next_tag_close		= '</li>';
		var $prev_tag_open		= '<li class="">';
		...
		var $anchor_class		= '';
		var $link_extracode = 'rel="nofollow"';
		...
		*/
		function create_links()
		{
			...
			if ($this->next_link !== FALSE AND $this->cur_page < $num_pages)
			{
				...
				$output .= $this->next_tag_open.'<a '.$this->link_extracode.' '.$this->anchor_class.'href="'.$this->base_url.$this->prefix.$i.$this->suffix.'">'.$this->next_link.'</a>'.$this->next_tag_close;
			}
