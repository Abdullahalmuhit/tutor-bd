    ...
    open_invoice: function () {
        ...
        var show_invoice = function (element) {
            ...
            var invoice_id = parseInt($this.attr('data-invoice-id')),
                    context = {
                        invoice_id: {
                            invoice_number:           $this.attr('data-invoice-id'),
                            invoice_date:             $this.attr('data-date'),
                            invoice_due_date:         $this.attr('data-due-date'),
                            payment_date:             $this.attr('data-payment-date'),
                            invoice_total_amount:     $this.attr('data-amount'),
                            invoice_job_id:           $this.attr('data-job_id'),
                            invoice_job_title:        $this.attr('data-job-title'),
                            invoice_paid_status:      $this.attr('data-paid-status'),
                            tutor_name:               $this.attr('data-tutor-name'),
                            tutor_id:                 $this.attr('data-tutor-id'),
                            tutor_email:              $this.attr('data-tutor-email'),
                            tutor_mobile:             $this.attr('data-tutor-mobile'),
                            tutor_gender:             $this.attr('data-tutor-gender'),
